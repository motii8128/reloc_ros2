...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '640,480,60', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '640,480,60', 'description': 'depth stream profile'},
